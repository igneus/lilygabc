...
\score {
  <<
    ...
    \new VaticanaLyrics \lyricsto "uniqueContext0" { % TODO voice ID relies on lilygabc internals
      Quó -- ni -- am "confirmáta est super nos miseri" -- cór -- di -- a e -- \skip 1 ius,_*
      "et véritas Dómini ma" -- net in æ -- tér -- num.
    }
    \new VaticanaLyrics \lyricsto "uniqueContext0" { % TODO voice ID relies on lilygabc internals
      Gló -- ri -- a \skip 1 Pa -- tri, et Fí -- li -- o,_*
      "et Spirí" -- tu -- i Sanc -- \skip 1 to.
    }
    \new VaticanaLyrics \lyricsto "uniqueContext0" { % TODO voice ID relies on lilygabc internals
      Si -- cut e -- "rat in princípio, et" nunc, \skip 1 et sem -- \skip 1 per,_*
